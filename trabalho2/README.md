...
2. Limpar arquivos objetos anteriores:
...
``` bash
nasm -f elf32 src/add.asm -o src/add.o && nasm -f elf32 src/calculadora.asm -o src/calculadora.o && nasm -f elf32 src/div.asm -o src/div.o && nasm -f elf32 src/exp.asm -o src/exp.o && nasm -f elf32 src/mod.asm -o src/mod.o && nasm -f elf32 src/mult.asm -o src/mult.o && nasm -f elf32 src/sub.asm -o src/sub.o && ld -m elf_i386 src/*.o -o calculadora && ./calculadora
```
